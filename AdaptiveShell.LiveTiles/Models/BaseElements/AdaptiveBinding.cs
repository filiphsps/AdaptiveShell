...
namespace AdaptiveShell.LiveTiles.Models.BaseElements {
    [ObjectModelClass("TileBinding", XmlTemplateParser.NotificationType.Tile)]
    public class AdaptiveBinding : AdaptiveParentElement {
        ...
        public AdaptiveBinding(XmlTemplateParser.NotificationType context) : base(context) { }
        ...
        [ObjectModelProperty("Content", null, XmlTemplateParser.NotificationType.Tile)]
        ...
        [ObjectModelProperty("Children", null, XmlTemplateParser.NotificationType.Toast)]
        ...
        internal void Parse(ParseResult result, XElement node, String baseUri, Boolean addImageQuery) {
            ...
            var container = new AdaptiveContainer(this.Context);
        ...
        protected virtual void ParseKnownAttributes(XElement node, AttributesHelper attributes, ParseResult result, String baseUri, Boolean addImageQuery) {
            ...
            switch (this.Template) {
                ...
                case Template.TileSmall:
                    this.Context = XmlTemplateParser.NotificationType.Tile;
                    break;
            }
